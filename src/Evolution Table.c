...
const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
	...
	[SPECIES_EEVEE] =            {{EVO_FRIENDSHIP_DAY, 0, SPECIES_ESPEON, 0},
								  ...
								  {EVO_MAP, MAP_NAME_VIRIDIAN_FOREST, SPECIES_LEAFEON, 0},
								  {EVO_ITEM, ITEM_ICE_STONE, SPECIES_GLACEON, 0},
								  {EVO_MAP, MAP_NAME_SEAFOAM_ISLANDS, SPECIES_GLACEON, 0},
								  {EVO_MAP, MAP_NAME_ICEFALL_CAVE, SPECIES_GLACEON, 0},
	...
	[SPECIES_CRABRAWLER] =       {{EVO_MAP, MAP_NAME_SEAFOAM_ISLANDS, SPECIES_CRABOMINABLE, 0},
								  {EVO_MAP, MAP_NAME_ICEFALL_CAVE, SPECIES_CRABOMINABLE, 0}},
