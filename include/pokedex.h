...
extern const u8 DEX_ENTRY_ALCREMIE_RUBY_STRAWBERRY[];
extern const u8 DEX_ENTRY_ALCREMIE_RUBY_BERRY[];
extern const u8 DEX_ENTRY_ALCREMIE_RUBY_CLOVER[];
extern const u8 DEX_ENTRY_ALCREMIE_RUBY_FLOWER[];
extern const u8 DEX_ENTRY_ALCREMIE_RUBY_LOVE[];
extern const u8 DEX_ENTRY_ALCREMIE_RUBY_RIBBON[];
extern const u8 DEX_ENTRY_ALCREMIE_RUBY_STAR[];
extern const u8 DEX_ENTRY_ALCREMIE_MATCHA_STRAWBERRY[];
extern const u8 DEX_ENTRY_ALCREMIE_MATCHA_BERRY[];
extern const u8 DEX_ENTRY_ALCREMIE_MATCHA_CLOVER[];
extern const u8 DEX_ENTRY_ALCREMIE_MATCHA_FLOWER[];
extern const u8 DEX_ENTRY_ALCREMIE_MATCHA_LOVE[];
extern const u8 DEX_ENTRY_ALCREMIE_MATCHA_RIBBON[];
extern const u8 DEX_ENTRY_ALCREMIE_MATCHA_STAR[];
extern const u8 DEX_ENTRY_ALCREMIE_MINT_STRAWBERRY[];
extern const u8 DEX_ENTRY_ALCREMIE_MINT_BERRY[];
extern const u8 DEX_ENTRY_ALCREMIE_MINT_CLOVER[];
extern const u8 DEX_ENTRY_ALCREMIE_MINT_FLOWER[];
extern const u8 DEX_ENTRY_ALCREMIE_MINT_LOVE[];
extern const u8 DEX_ENTRY_ALCREMIE_MINT_RIBBON[];
extern const u8 DEX_ENTRY_ALCREMIE_MINT_STAR[];
extern const u8 DEX_ENTRY_ALCREMIE_LEMON_STRAWBERRY[];
extern const u8 DEX_ENTRY_ALCREMIE_LEMON_BERRY[];
extern const u8 DEX_ENTRY_ALCREMIE_LEMON_CLOVER[];
extern const u8 DEX_ENTRY_ALCREMIE_LEMON_FLOWER[];
extern const u8 DEX_ENTRY_ALCREMIE_LEMON_LOVE[];
extern const u8 DEX_ENTRY_ALCREMIE_LEMON_RIBBON[];
extern const u8 DEX_ENTRY_ALCREMIE_LEMON_STAR[];
extern const u8 DEX_ENTRY_ALCREMIE_SALTED_STRAWBERRY[];
extern const u8 DEX_ENTRY_ALCREMIE_SALTED_BERRY[];
extern const u8 DEX_ENTRY_ALCREMIE_SALTED_CLOVER[];
extern const u8 DEX_ENTRY_ALCREMIE_SALTED_FLOWER[];
extern const u8 DEX_ENTRY_ALCREMIE_SALTED_LOVE[];
extern const u8 DEX_ENTRY_ALCREMIE_SALTED_RIBBON[];
extern const u8 DEX_ENTRY_ALCREMIE_SALTED_STAR[];
extern const u8 DEX_ENTRY_ALCREMIE_RUBYSWIRL_STRAWBERRY[];
extern const u8 DEX_ENTRY_ALCREMIE_RUBYSWIRL_BERRY[];
extern const u8 DEX_ENTRY_ALCREMIE_RUBYSWIRL_CLOVER[];
extern const u8 DEX_ENTRY_ALCREMIE_RUBYSWIRL_FLOWER[];
extern const u8 DEX_ENTRY_ALCREMIE_RUBYSWIRL_LOVE[];
extern const u8 DEX_ENTRY_ALCREMIE_RUBYSWIRL_RIBBON[];
extern const u8 DEX_ENTRY_ALCREMIE_RUBYSWIRL_STAR[];
extern const u8 DEX_ENTRY_ALCREMIE_CARAMEL_STRAWBERRY[];
extern const u8 DEX_ENTRY_ALCREMIE_CARAMEL_BERRY[];
extern const u8 DEX_ENTRY_ALCREMIE_CARAMEL_CLOVER[];
extern const u8 DEX_ENTRY_ALCREMIE_CARAMEL_FLOWER[];
extern const u8 DEX_ENTRY_ALCREMIE_CARAMEL_LOVE[];
extern const u8 DEX_ENTRY_ALCREMIE_CARAMEL_RIBBON[];
extern const u8 DEX_ENTRY_ALCREMIE_CARAMEL_STAR[];
extern const u8 DEX_ENTRY_ALCREMIE_RAINBOW_STRAWBERRY[];
extern const u8 DEX_ENTRY_ALCREMIE_RAINBOW_BERRY[];
extern const u8 DEX_ENTRY_ALCREMIE_RAINBOW_CLOVER[];
extern const u8 DEX_ENTRY_ALCREMIE_RAINBOW_FLOWER[];
extern const u8 DEX_ENTRY_ALCREMIE_RAINBOW_LOVE[];
extern const u8 DEX_ENTRY_ALCREMIE_RAINBOW_RIBBON[];
extern const u8 DEX_ENTRY_ALCREMIE_RAINBOW_STAR[];
...
extern const u8 DEX_ENTRY_CALYREX_SHADOW[];
